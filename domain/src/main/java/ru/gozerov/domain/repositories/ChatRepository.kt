...
interface ChatRepository {
    ...
    suspend fun getTrainerChatMessages(userId: Int): Flow<PagingData<ChatItem>>

    suspend fun getClientChats(query: String): List<ChatCard>

    suspend fun getClientChatMessages(trainerId: Int): Flow<PagingData<ChatItem>>

    suspend fun runWebSocket()

    suspend fun sendMessage(to: Int, message: String, serviceId: Int?)

    suspend fun checkNewMessages(): SharedFlow<ChatItem.ChatMessage>
